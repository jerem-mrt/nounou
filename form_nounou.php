                         ...
                         <form  autocomplete="off" id="appointment-form" role="form" method="post" action="form_nounou_action.php" enctype="multipart/form-data">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                  ...
                                  <div class="col-md-12 col-sm-12 autocomplete">
                                         <label for="nomV">Ville</label> <br />
                                        <input id="nomV" type="text" name="nomV" placeholder="Votre ville">
                                   </div>
                                  
                                  <script>
                                      /*initiate the autocomplete function on the "nomV" element, and pass along the cities array as possible autocomplete values:*/
...
autocomplete(document.getElementById("nomV"), nomVilles);
</script>
